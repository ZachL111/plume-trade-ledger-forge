...
$repo = "plume-trade-ledger-forge"
$language = "Zig"
$category = "Trading systems"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/plume-trade-ledger-walkthrough.md")) {
