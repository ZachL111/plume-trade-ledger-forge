...
`plume-trade-ledger-forge` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for ledger systems, covering diagnostic reporting, negative fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 164. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 2.
