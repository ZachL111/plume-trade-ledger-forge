...
plume-trade-ledger-forge is a Zig project for trading systems. It focuses on this technical goal: Design a Zig verification harness for ledger systems, covering diagnostic reporting, negative fixtures, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 164, risk penalty 6, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
