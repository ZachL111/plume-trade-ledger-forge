"""Regression checks for the plume-trade-ledger-forge casebook."""
...
from casebook.harness import assert_expected, plume_trade_ledger_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_trade_ledger_forge_summary(), assert_expected())
